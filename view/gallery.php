...
<div class="container">
    ...
    <header class="">
        <nav class="nav">
            ...
            <a class="button" href="/gallery/<?php echo $_SESSION['user']['usr_name'];?>">
                <div class="nav-user">
        ...
        <?php foreach ($photoTableData as $item => $value) { ?>
            ...
            <div class="main-wrap" id="<?php echo $value['photo_id'];?>">
                ...
                <div class="likes_comments">
                    ...
                    <img class="delete_photo" id="<?php echo $value['photo_id'];?>" data-photopath="<?php echo $value['local_path']; ?>" src="../css/photo/delete_icon.png" alt="" onclick=delete_photo(this)>
                </div>
...
<div class="pagination">
    <?php for ($i = 1; $i <= $count_of_pages; $i++) {?>
        <a data-page="<?php echo $i;?>" href="/gallery/<?php echo $_SESSION['user']['usr_name'];?>" onclick="paggination(this)"><?php echo $i;?></a>
    <?php }?>
</div>
<footer class="">
    <div class="footer">
